...
class SingleBook extends React.Component {
    ...
    render() {
        ...
        <>
        <Col xs={12} md={6} lg={3}>
                <Card key={this.props.book.asin} className="bg-dark text-white my-3 d-flex " style={{ width: '10rem', border: this.state.selected ? '3px solid red' :'none'  }} onClick={()=>this.setState({selected:!this.state.selected})}>
